...
def add_png_decoding(input_width, input_height, input_depth, input_mean,
  ...
  Returns:
    Tensors for the node to feed JPEG data into, and the output of the
      preprocessing steps.
  """
  png_data = tf.placeholder(tf.string, name='DecodeJPGInput')
  decoded_image = tf.image.decode_png(png_data, channels=input_depth) #sua lai thanh png
  decoded_image_as_float = tf.cast(decoded_image, dtype=tf.float32)
  decoded_image_4d = tf.expand_dims(decoded_image_as_float, 0)
      ...
      if do_distort_images:
        (train_bottlenecks,
         train_ground_truth) = get_random_distorted_bottlenecks(
             ...
             FLAGS.image_dir, distorted_png_data_tensor,
